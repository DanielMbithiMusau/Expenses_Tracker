defmodule ExpensesTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExpensesTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExpensesTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
